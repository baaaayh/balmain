        ...
        >
          ...
          >
            <div className={clsx(styles["side-nav__contents"])}>
              ...
              <SideNavUtils navState={isOpen} isExpended={isExpended} />
              <SideNavMenu navState={isOpen} isExpended={isExpended} />
            </div>
            <SideNavFooter navState={isOpen} isExpended={isExpended} />
          </div>
        </nav>
      }
    </MenuProvider>
